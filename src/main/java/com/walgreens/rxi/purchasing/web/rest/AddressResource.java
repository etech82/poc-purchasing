...
import com.walgreens.rxi.purchasing.domain.Address;
import com.walgreens.rxi.purchasing.repository.AddressRepository;
...
/**
 * REST controller for managing {@link com.walgreens.rxi.purchasing.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "purchasingAddress";
            ...
            .map(
                existingAddress -> {
                    ...
                    if (address.getTimezone() != null) {
                        existingAddress.setTimezone(address.getTimezone());
                    }
